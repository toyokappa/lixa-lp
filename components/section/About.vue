      ...
      .col-lg-4.col-12
        ...
        .description
          p
            div
              | お客様とトレーナーの
              span.text-original 1対1
              | で
            div トレーニングを行っていただきます。
          p
            div 個々人の目標に合わせたメニューをご提案。
          p
            div 正しく安全なフォームで筋トレが出来るよう
            div
              | トレーナーが
